...
OpenAI GPT (paid fallback) or Groq (LLaMA3) — only if the local LLM is unavailable or low confidence, it escalates to ChatGPT but as of now using Groq(LLaMA3) Free tier as cloud LLM backend
