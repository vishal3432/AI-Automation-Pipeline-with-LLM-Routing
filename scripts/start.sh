#!/bin/bash
# ─── AI Automation Platform — Quick Start Script ──────────────────────────────
...
docker exec ai_platform_ollama ollama pull mistral || echo "⚠️  Ollama model pull failed — you can do this manually later"
